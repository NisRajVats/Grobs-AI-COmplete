...
const ResumeEdit = () => {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (response.data && response.data.parsed_data) {
        setResumeData((prev) => ({
          ...prev,
          rawParsedData: response.data.parsed_data,
        }));
      }
    } catch (error) {
  ...
  return (
    <div className="flex flex-col lg:flex-row h-[calc(100vh-160px)] gap-8">
      {/* Sidebar Controls */}
      <div className="w-full lg:w-112.5 flex flex-col gap-6 overflow-y-auto pr-2 custom-scrollbar">
                  ...
                  <div className="grid grid-cols-1 gap-6">
                    <div className="space-y-2">
                      ...
                      <input
                        ...
                        className="w-full bg-slate-900/50 border border-white/10 rounded-xl px-4 py-3 text-white focus:ring-2 focus:ring-blue-500/30 transition-all"
                      />
                    </div>
                    <div className="space-y-2">
                      <label className="text-xs font-bold text-slate-500 uppercase tracking-wider">
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="relative">
                          ...
                          <input
                            ...
                            onChange={handlePersonalChange}
                            className="w-full bg-slate-900/50 border border-white/10 rounded-xl pl-10 pr-4 py-3 text-sm text-white focus:ring-2 focus:ring-blue-500/30"
              ...
              {activeTab === "experience" && (
                <div className="space-y-4">
                  ...
                  {resumeData.experience.map((exp, index) => (
                    <div
                      key={index}
                      className="card-glass p-6 space-y-4 group relative"
                    >
                      <button
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex flex-wrap gap-2 pt-2">
                      {resumeData.skills.map((skill, index) => (
                        <div
                          key={index}
                          className="flex items-center gap-2 px-3 py-1.5 bg-blue-600/10 border border-blue-500/20 rounded-lg text-blue-400 font-bold text-sm"
                        >
      ...
      <div className="flex-1 bg-slate-900/40 border border-white/5 rounded-[40px] p-12 overflow-y-auto custom-scrollbar shadow-2xl relative">
        <div className="max-w-200 mx-auto bg-white rounded-sm shadow-2xl p-16 min-h-275 text-slate-900 font-serif">
          {/* Header */}
